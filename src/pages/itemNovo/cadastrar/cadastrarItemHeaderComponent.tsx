        ...
        <>
            <div className='cadastrarItemHeader'>
                ...
                <div className='cadastrarItemHeader-Breadcrumb-corpo'>
                    <div className={pagina === 1 ? 'cadastrarItemHeader-Breadcrumb-item01' : 'cadastrarItemHeader-Breadcrumb-item02'}>
                    ...
                    <div className={pagina === 2 ? 'cadastrarItemHeader-Breadcrumb-item01' : 'cadastrarItemHeader-Breadcrumb-item02'}>
